...
/**********************************************************************
 * A class that contains the functionality of the chess game.
 *
...
//    private ArrayList<String> movedPlayer;
	...
	public ChessModel() {
		...
		// storing data for undo-ing moves
...
//        movedPlayer = new ArrayList<>();
	...
	/*****************************************************************
	 * A method that starts a new game of chess and resets the board.
	 *****************************************************************/
	public void newGame(){
		...
		// setting remaining white pieces
		...
		// setting remaining black pieces
	...
	/*****************************************************************
	 * Saves and stores the data for a specific move.
	 *
	 * @param row the row
	...
	/*****************************************************************
	 * Method that checks if the game is complete (checkmate).
	 * Checks to see if the King is checkmated or can move out the
	 * way (i.e., uncheck itself) or another player can block
	 * the check.
	 *
...
/*					attemptMove = new Move(kingRow, kingCol, r, c);
	...
	public boolean inCheck(Player p) {
		...
		// finds the current player's king
		for (int r = 0; r < numRows(); r++) {
			for (int c = 0; c < numColumns(); c++) {
				if (board[r][c] != null && board[r][c].type().equals("King")
		...
		// checks to see if any of the other player's pieces put it in check
		for (int r = 0; r < numRows(); r++)
			for (int c = 0; c < numColumns(); c++) {
				if (board[r][c] != null)
	...
	/*****************************************************************
	 * Returns the piece at the given space on the board.
	 *
	 * @param row the row
	...
	/*****************************************************************
	 * Method that checks if a spot on the board is occupied.
	 *
	 * @param r the row
	 * @param c the column
	...
	/*****************************************************************
	 * Sets a piece at a specific spot on the board.
	 *
	 * @param row the row
	 * @param column the column
	...
	/*****************************************************************
	 * An AI that controls the black pieces in chess.
	 *****************************************************************/
	public void AI() {
		/*
