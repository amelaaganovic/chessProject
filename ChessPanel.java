...
//        lastMove.setAlignmentX(Component.CENTER_ALIGNMENT);
    ...
    private void createIcons() {
        ...
        wRook = new ImageIcon("./src/ChessVersion3/images/wRook.png");
        wBishop = new ImageIcon("./src/ChessVersion3/images/wBishop.png");
        wQueen = new ImageIcon("./src/ChessVersion3/images/wQueen.png");
        wKing = new ImageIcon("./src/ChessVersion3/images/wKing.png");
        wPawn = new ImageIcon("./src/ChessVersion3/images/wPawn.png");
        wKnight = new ImageIcon("./src/ChessVersion3/images/wKnight.png");

        bRook = new ImageIcon("./src/ChessVersion3/images/bRook.png");
        bBishop = new ImageIcon("./src/ChessVersion3/images/bBishop.png");
        bQueen = new ImageIcon("./src/ChessVersion3/images/bQueen.png");
        bKing = new ImageIcon("./src/ChessVersion3/images/bKing.png");
        bPawn = new ImageIcon("./src/ChessVersion3/images/bPawn.png");
        bKnight = new ImageIcon("./src/ChessVersion3/images/bKnight.png");
    }
