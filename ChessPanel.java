...
public class ChessPanel extends JPanel {
    ...
    private void createIcons() {
        ...
        wRook = new ImageIcon("./src/ChessVersion2/images/wRook.png");
        wBishop = new ImageIcon("./src/ChessVersion2/images/wBishop.png");
        wQueen = new ImageIcon("./src/ChessVersion2/images/wQueen.png");
        wKing = new ImageIcon("./src/ChessVersion2/images/wKing.png");
        wPawn = new ImageIcon("./src/ChessVersion2/images/wPawn.png");
        wKnight = new ImageIcon("./src/ChessVersion2/images/wKnight.png");

        bRook = new ImageIcon("./src/ChessVersion2/images/bRook.png");
        bBishop = new ImageIcon("./src/ChessVersion2/images/bBishop.png");
        bQueen = new ImageIcon("./src/ChessVersion2/images/bQueen.png");
        bKing = new ImageIcon("./src/ChessVersion2/images/bKing.png");
        bPawn = new ImageIcon("./src/ChessVersion2/images/bPawn.png");
        bKnight = new ImageIcon("./src/ChessVersion2/images/bKnight.png");
    }
...
//                                    toggleSpace(fromRow, fromCol, false);
                                    ...
                                    //model.move(m); //FIXME this was commented out and placed in model's isValidMove(), but it messed up the undo button
                                    model.setNextPlayer();
                                }
