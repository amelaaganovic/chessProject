...
//        lastMove = new JLabel("Last Move:  none");
    ...
    private void createIcons() {
        ...
        wRook = new ImageIcon("./src/ChessVersion5/images/wRook.png");
        wBishop = new ImageIcon("./src/ChessVersion5/images/wBishop.png");
        wQueen = new ImageIcon("./src/ChessVersion5/images/wQueen.png");
        wKing = new ImageIcon("./src/ChessVersion5/images/wKing.png");
        wPawn = new ImageIcon("./src/ChessVersion5/images/wPawn.png");
        wKnight = new ImageIcon("./src/ChessVersion5/images/wKnight.png");

        bRook = new ImageIcon("./src/ChessVersion5/images/bRook.png");
        bBishop = new ImageIcon("./src/ChessVersion5/images/bBishop.png");
        bQueen = new ImageIcon("./src/ChessVersion5/images/bQueen.png");
        bKing = new ImageIcon("./src/ChessVersion5/images/bKing.png");
        bPawn = new ImageIcon("./src/ChessVersion5/images/bPawn.png");
        bKnight = new ImageIcon("./src/ChessVersion5/images/bKnight.png");
    }
